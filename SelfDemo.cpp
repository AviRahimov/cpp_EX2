...
int main(){
    ...
    cout << "playing status for " << p1.getName() << " after starting the game is: " << p1.IsPlaying() << endl;
    cout << "playing status for " << p2.getName() << " after starting the game is: " << p2.IsPlaying() << endl;
